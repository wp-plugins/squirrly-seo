<div id="sq_settings" >
    <form id="sq_settings_form" name="settings" action="" method="post" enctype="multipart/form-data">
        ...
        <div id="sq_settings_title" ><?php _e('Squirrly settings', _SQ_PLUGIN_NAME_); ?> <input type="submit" name="sq_update" value="<?php _e('Save settings', _SQ_PLUGIN_NAME_) ?> &raquo;" /> <a href="post-new.php" id="sq_goto_newpost" <?php echo (($view->options['sq_api'] <> '') ? '' : 'style="display:none"') ?> /><?php _e('Optimize with Squirrly', _SQ_PLUGIN_NAME_) ?></a></div>
        <div id="sq_settings_body">
            <div id="sq_settings_left" >
                ...
                ?>
                <fieldset>
                    <legend><?php _e('User level', _SQ_PLUGIN_NAME_); ?></legend>
                    <div class="sq_option_content">
                        <div class="sq_switch sq_beginner_user">
                            ...
                            <label for="sq_beginner_on" class="sq_switch-label sq_switch-label-off"><?php _e('Beginner', _SQ_PLUGIN_NAME_); ?></label>
                            ...
                            <label for="sq_beginner_off" class="sq_switch-label sq_switch-label-on"><?php _e('Advanced', _SQ_PLUGIN_NAME_); ?></label>
                            <span class="sq_switch-selection"></span>
                        </div>
                    </div>
                    <span class="sq_settings_info"><?php _e('Select Advanced only if you have SEO knowledge.', _SQ_PLUGIN_NAME_); ?></span>

                    <div id="sq_beginner_option_details" class="sq_option_details" <?php echo (($view->options['sq_beginner_user'] == 0) ? 'style="display: none;"' : '') ?>>
                        <div class="sq_header"><?php _e('What does the Beginner option bring you:', _SQ_PLUGIN_NAME_); ?></div>
                        <ul>
                            <li><?php _e('Squirrly <strong>finds the optimum Title and Description</strong> for each page of your blog but you can still customize the home page Title and Description if you want.', _SQ_PLUGIN_NAME_); ?></li>
                            <li><?php _e('Squirrly <strong>manages the sitemap</strong> for your blog and pings it to Google and Bing every time you add a new article. This ensures that your articles get indexed much faster.', _SQ_PLUGIN_NAME_); ?></li>
                            <li><?php _e('Squirrly <strong>adds the Facebook required meta</strong>, so that when your readers share your page or article, it looks really good.', _SQ_PLUGIN_NAME_); ?></li>
                            <li><?php _e('You can connect your site with your <strong>Google Plus</strong> and <strong>Google Analytics</strong> accounts.', _SQ_PLUGIN_NAME_); ?></li>
                            <li><?php _e('You can add the site icon (also known as favicon) and Squirrly will set it up to look good for <strong>Apple devices</strong>.', _SQ_PLUGIN_NAME_); ?></li>
                        </ul>
                    </div>

                    <div id="sq_advanced_option_details" class="sq_option_details" <?php echo (($view->options['sq_beginner_user'] == 1) ? 'style="display: none;"' : '') ?>>
                        <div class="sq_header"><?php _e('What does the Advanced option bring you:', _SQ_PLUGIN_NAME_); ?></div>
                        <ul>
                            <li><?php _e('More <strong>SEO options</strong> are available on the Settings page.', _SQ_PLUGIN_NAME_); ?></li>
                            <li><?php _e('You can connect your site with <strong>Google Webmaster Tools</strong>, <strong>Bing Webmaster Tools</strong> and <strong>Facebook Insights</strong>.', _SQ_PLUGIN_NAME_); ?></li>
                            <li><?php _e('You can see the <strong>Snippet</strong> when you edit your Post or Page.', _SQ_PLUGIN_NAME_); ?></li>
                            <li><?php _e('You can <strong>customize the Title and Description</strong> of each Post/Page from within the snippet.', _SQ_PLUGIN_NAME_); ?></li>
                        </ul>
                    </div>
                </fieldset>
                <fieldset>
                    <legend><?php _e('Let Squirrly automatically optimize my blog', _SQ_PLUGIN_NAME_); ?></legend>
                    <div>
                        <span class="sq_option_disclamer"><?php _e('<strong>For SEO Setting you can use "All In One SEO", "Wordpress SEO by Yoast", or other such plugins.</strong> <br /><br />If you want, you can also use the built-in settings from Squirrly (useful for beginners), by switching Yes below.', _SQ_PLUGIN_NAME_); ?></span>
                        ...
                        <ul id="sq_settings_sq_use" class="sq_settings_info">
                            ...
                            <li>
                                ...
                                <div class="sq_option_content sq_option_content_small">
                                    ...
                                    <span><?php _e('Add <strong>canonical</strong> link in home page', _SQ_PLUGIN_NAME_); ?></span>
                                </div>
                            </li>
                            <li>
                                <?php
                                ...
                                <div class="sq_option_content sq_option_content_small">
                                    ...
                                    <span><?php _e('Add the <strong>XML Sitemap</strong> for search engines', _SQ_PLUGIN_NAME_); ?>: <strong><?php echo '/sitemap.xml' ?></strong></span>
                                </div>
                            </li>
                            <li>
                                <?php
                            ...
                            <li>
                                ...
                                <div class="sq_option_content sq_option_content_small">
                                    ...
                                    <span><?php echo __('Add the <strong>Facebook meta objects</strong> for a good looking share. ', _SQ_PLUGIN_NAME_) . ' <a href="https://developers.facebook.com/tools/debug/og/object?q=' . urlencode(get_bloginfo('wpurl')) . '" target="_blank" title="Facebook Object Validator">Check here</a>'; ?></span>
                                </div>
                            </li>
                            <li>
                                <?php
                ...
                <fieldset id="sq_title_description_keywords" style="<?php echo (($view->options['sq_use'] == 0) ? 'display:none;' : ''); ?>">
                    <legend><?php _e('First page optimization (Title, Description, Keywords)', _SQ_PLUGIN_NAME_); ?></legend>
                    <ul id="sq_settings_sq_use" class="sq_settings_info">
                        <li>
                            <?php
                            $auto_option = false;
                ...
                <fieldset>
                    <legend><?php _e('Squirrly Options', _SQ_PLUGIN_NAME_); ?></legend>
                    ...
                    <div class="sq_option_content">
                        ...
                        <span><?php _e('Use <strong> V2 of the SEO Live Assistant</strong>.', _SQ_PLUGIN_NAME_); ?></span>
                    </div>
                </fieldset>
            </div>
            ...
            <div id="sq_settings_right">
                <fieldset>
                    <legend><?php _e('Change the Website Icon', _SQ_PLUGIN_NAME_); ?></legend>
                    <div>
                        <p>
                    ...
                    <span class="sq_settings_info"><?php echo sprintf(__('You can use %shttp://convertico.com/%s to convert your photo to icon and upload it here after that.', _SQ_PLUGIN_NAME_), '<a href="http://convertico.com/" target="_blank">', '</a>'); ?></span>
                ...
                <fieldset >
                    <legend><?php _e('Tool for Search Engines', _SQ_PLUGIN_NAME_); ?></legend>
                    <div>
