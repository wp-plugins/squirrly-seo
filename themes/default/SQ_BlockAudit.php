<div id="sq_option_audit">
    <span id="sq_option_audit_link" style="display: none">
        <?php echo '<a class="sq_button"  target="_blank">' . __('Check your site audit', _PLUGIN_NAME_) . '</a>' ?>
    </span>
    <span id="sq_option_audit_notmade" style="display: none">
        <?php _e('The audit will be ready in 1-3 days ...', _PLUGIN_NAME_) ?>
    </span>
    <span id="sq_option_audit_notready" style="display: none">
        <?php _e('The audit will be ready soon ...', _PLUGIN_NAME_) ?>
    </span>
    <span id="sq_option_audit_error" style="display: none">
        <?php _e('Squirrly receives an error page while checking your site ...', _PLUGIN_NAME_) ?>
    </span>
</div>
