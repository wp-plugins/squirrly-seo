<div id="sq_posts" >
    ...
    <div id="sq_posts_subtitle" style="font-size: 14px;color: red;padding: 0px;margin: 0;text-align: center;line-height: 15px;"><?php _e('If you recheck the google rank, let 10-20 seconds between requests to prevent google to block your IP.', _SQ_PLUGIN_NAME_); ?> </div>
